...
const products = [
  ...
  { title: 'The Lagos Code', description: 'A tech thriller set in Lagos about a hacker who uncovers a government conspiracy.', author: AUTHOR_ID, authorName: 'Amara Nwosu', contentType: 'eBook', genre: 'Thriller', tags: ['thriller','tech'], price: 1500, ratingAvg: 4.7, status: 'live', publishedAt: new Date() },
  ...
  { title: 'Beneath Abuja', description: 'A novel about ancient secrets buried beneath Nigeria\'s capital city.', author: AUTHOR_ID, authorName: 'Chisom Eze', contentType: 'Novel', genre: 'Mystery', tags: ['mystery','history'], price: 1200, ratingAvg: 4.5, status: 'live', publishedAt: new Date() },
  { title: 'Tide Walker', description: 'A manhwa about a girl who can walk between ocean dimensions.', author: AUTHOR_ID, authorName: 'Folake Aina', contentType: 'Manhwa', genre: 'Adventure', tags: ['adventure','fantasy'], price: 2200, ratingAvg: 4.8, status: 'live', publishedAt: new Date() },
  ...
  { title: 'Freelance in Nigeria', description: 'A practical eBook guide to building a freelance career in Nigeria.', author: AUTHOR_ID, authorName: 'Ada Okonkwo', contentType: 'eBook', genre: 'Non-fiction', tags: ['business','career'], price: 2000, ratingAvg: 4.7, status: 'live', publishedAt: new Date() },
];
